  ...
  if (viewMode === 'list') {
    return (
      ...
      >
        {/* Discount Badge */}
        {showDiscountBadge && (
          <div className="absolute left-2 top-0 sm:left-3 sm:top-0 z-10 flex items-center justify-center scale-90 sm:scale-100" style={{ width: '29px', height: '28px', pointerEvents: 'none' }}>
