...
export default function OrdersTable({ 
  ...
  const fetchOrders = async () => {
    try {
      ...
      const endpoint = statusFilter 
        ...
        : `${process.env.NEXT_PUBLIC_API_URL}/orders/admin`
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    const matchesStatus = !showStatusFilter || filterStatus === "all" || order.status === filterStatus
    const matchesWarehouse = !showWarehouseFilter || filterWarehouse === "all" || order.warehouseInfo.warehouseName === filterWarehouse
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-codGray">{title}</h2>
        ...
        <div className="bg-white rounded-lg p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-codGray">{orders.length}</p>
            </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-brand-primary">{filteredOrders.length}</p>
            </div>
      ...
      {/* Filters */}
      <div className="bg-white rounded-lg p-6 shadow-md">
        <div className={`grid grid-cols-1 gap-4 ${showWarehouseFilter ? 'md:grid-cols-2' : 'md:grid-cols-1'}`}>
